...
Next, use `facet_grid` to split this graph based on whether the pateint has exercise induced anging or not. Make sure to wrap your variable in `factor()` to convert the numeric into a factor variable. 
```{r}
